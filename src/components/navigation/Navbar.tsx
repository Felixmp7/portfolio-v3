    ...
    return (
        <header className='pt-5 sm:pt-10'>
            <nav className={navClasses}>
                ...
                <ul className="hidden sm:flex gap-8 px-8 py-3 shadow-md dark:border-none border-[0.5px] dark:bg-neutral-700 rounded-3xl">
                    <NavbarItems />
                </ul>
                <BurgerMenu />
                <button
                    aria-label="Toggle theme"
                    className='p-2 sm:px-4 sm:py-3 text-xl sm:text-2xl dark:text-inherit text-yellow-500 bg-yellow-50 duration-150 ease-in rounded-full dark:bg-neutral-700 dark:hover:text-white shadow-md dark:border-none border-[0.5px] border-yellow-300'
