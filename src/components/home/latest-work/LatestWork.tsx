...
export const LatestWork = () => {
    return (
        <div className='w-full h-full p-5 border rounded-md border-zinc-300 dark:border-zinc-700'>
            ...
            <button className='flex items-center justify-center w-full py-3 rounded-lg dark:opacity-80 dark:bg-zinc-700 bg-zinc-100 hover:bg-zinc-200 dark:hover:opacity-100'>
